                ...
                <div className="space-y-4 md:space-y-6 lg:space-y-10 max-w-6xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 mb-6 md:mb-8 lg:mb-10 mt-6 md:mt-8 lg:mt-10">
                    ...
                    <div className="col-span-1 md:col-span-2 flex flex-col items-center">
                      ...
                      <div className="text-center mb-3">
                        <h3 className="text-base md:text-lg lg:text-xl font-bold uppercase tracking-wider mb-1.5 lg:mb-2">{ph.colorPalette.objectives}</h3>
                      ...
                      <div className="grid grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-md 3xl:max-w-lg 4xl:max-w-xl w-full">
                        ...
                        <div className="space-y-1.5 text-center">
                          <div>
                            <div className="text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold text-foreground">{ph.colorPalette.emotionalConnection}</div>
                            <div className="text-[9px] md:text-[10px] text-muted-foreground italic">{ph.colorPalette.emotionalDesc}</div>
                          </div>
                          <div>
                            <div className="text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold text-foreground">{ph.colorPalette.audienceStudy}</div>
                            <div className="text-[9px] md:text-[10px] text-muted-foreground italic">{ph.colorPalette.audienceDesc}</div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1.5 text-center">
                          <div>
                            <div className="text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold text-foreground">{ph.colorPalette.attentionToDetail}</div>
                            <div className="text-[9px] md:text-[10px] text-muted-foreground italic">{ph.colorPalette.detailDesc}</div>
                          </div>
                          <div>
                            <div className="text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold text-foreground">{ph.colorPalette.originalDesigns}</div>
                            <div className="text-[9px] md:text-[10px] text-muted-foreground italic">{ph.colorPalette.originalDesc}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm md:text-base lg:text-lg font-bold uppercase tracking-wider text-center lg:text-left">{ph.colorPalette.lightPalette}</h3>
                        ...
                        <div className="space-y-1 flex-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.pastelPink}</span>
                            </div>
                          </div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.warmBrown}</span>
                            </div>
                          </div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.softWhite}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-2">
                      <h3 className="text-sm md:text-base lg:text-lg font-bold uppercase tracking-wider text-center lg:text-left">{ph.colorPalette.darkPalette}</h3>
                      <div className="flex gap-2 items-start">
                        <div className="w-16 md:w-20 lg:w-24 flex-shrink-0">
                          <img
                            src="/projects/i4.png"
                        ...
                        <div className="space-y-1 flex-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.lavenderPurple}</span>
                            </div>
                          </div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.softCoral}</span>
                            </div>
                          </div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[7px] md:text-[7.5px] text-muted-foreground font-semibold">{ph.colorPalette.darkPurple}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-5 md:space-y-6 lg:space-y-8 w-full pt-4 lg:pt-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-2.5 md:gap-3 w-full px-2">
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.sunFlowStep1}</p>
                      ...
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.sunFlowStep2}</p>
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      ...
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.sunFlowStep3}</p>
                    </div>

                    {/* Luna - Flujo con flechas */}
                    <div className="flex flex-col md:flex-row items-center justify-center gap-2.5 md:gap-3 w-full px-2">
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.moonFlowStep1}</p>
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      <Button variant="outline" size="sm" className="px-3 py-2 h-auto min-w-[44px] flex-shrink-0">
                        <Moon className="h-4 w-4 lg:h-5 lg:w-5" />
                      </Button>
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.moonFlowStep2}</p>
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      ...
                      <img src="/projects/f1.png" alt="→" className="h-7 md:h-9 lg:h-11 w-auto opacity-70 rotate-90 md:rotate-0 flex-shrink-0" />
                      <p className="text-[10px] md:text-xs lg:text-sm italic text-foreground/90 w-full md:w-36 lg:w-40 leading-tight text-center font-medium">{ph.colorPalette.moonFlowStep3}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="group relative min-h-screen lg:h-screen w-full overflow-y-auto lg:overflow-hidden border-b lg:snap-start lg:snap-always">
        ...
        {projectNumber && (
          <div className="absolute right-2 md:right-3 top-2 md:top-3 z-30 hidden lg:flex lg:flex-col lg:items-end lg:gap-1.5 max-w-[180px]">
            ...
            <div className="bg-background/30 inline-flex items-center gap-2 rounded-full px-2 py-1 backdrop-blur-md">
              ...
              <LocaleToggle className="text-foreground/60 hover:text-foreground transition-all duration-200 hover:scale-110" />
              <div className="bg-border h-4 w-px" />
              <button onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")} className="transition-transform duration-200 hover:scale-110" aria-label={t.nav.changeTheme}>
                <ThemeToggleButton2 className="size-4" theme={resolvedTheme} />
              </button>
              <div className="bg-border h-4 w-px" />
              <button onClick={() => { const heroSection = document.querySelector('#home'); if (heroSection) { heroSection.scrollIntoView({ behavior: 'smooth', block: 'start' }); } }} className="text-foreground/60 hover:text-foreground transition-all duration-200 hover:scale-110" aria-label={t.projectLabels.backToTop}>
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="text-center py-6 md:py-8">
            <h2 className="font-incognito text-lg md:text-xl lg:text-2xl font-bold mb-1">
              {ph.designProcess.title}
            </h2>
            <p className="text-[9px] md:text-xs text-muted-foreground">{ph.designProcess.subtitle}</p>
              ...
              <div className="space-y-4 md:space-y-5 w-full max-w-md 3xl:max-w-lg 4xl:max-w-xl">
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.visualIdentity}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p className="font-mono">
                      <span className="font-bold text-primary">Estilo:</span> {ph.designProcess.visualStyle}
                    </p>
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.visualDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.vivePalette}</p>
                      <p>— {ph.designProcess.roundedTypo}</p>
                      <p>— {ph.designProcess.illustrations}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.contentFocus}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.contentDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.gallery}</p>
                      <p>— {ph.designProcess.streamClips}</p>
                      <p>— {ph.designProcess.styleDesc}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.metricsReach}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.metricsDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.followers}</p>
                      <p>— {ph.designProcess.avgReach}</p>
                      <p>— {ph.designProcess.collabValue}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 md:space-y-5 w-full max-w-md 3xl:max-w-lg 4xl:max-w-xl">
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.wireframesTitle}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.wireframesDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.structurePlanning}</p>
                      <p>— {ph.designProcess.interactiveProto}</p>
                      <p>— {ph.designProcess.componentSystem}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.responsiveDesign}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.responsiveDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.mobileFirst}</p>
                      <p>— {ph.designProcess.customBreakpoints}</p>
                      <p>— {ph.designProcess.fluidGrid}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1 md:space-y-1.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="font-incognito text-xs md:text-sm 3xl:text-lg 4xl:text-xl font-bold">{ph.designProcess.uxOptimization}</h3>
                  </div>
                  <div className="space-y-0.5 md:space-y-1 text-[8px] md:text-[9px] lg:text-[10px] 3xl:text-sm 4xl:text-base leading-relaxed text-foreground/70">
                    <p dangerouslySetInnerHTML={{ __html: ph.designProcess.uxDesc }} />
                    <div className="border-l border-primary/50 pl-2 space-y-0.5">
                      <p>— {ph.designProcess.userTesting}</p>
                      <p>— {ph.designProcess.continuousIteration}</p>
                      <p>— {ph.designProcess.accesibility}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center py-3 md:py-4 mb-12 md:mb-16">
            <div className="relative inline-block py-3 px-6">
              ...
              <div className="absolute bottom-0 left-0 h-2.5 w-2.5 border-b border-l border-primary/50" />
              <div className="absolute bottom-0 right-0 h-2.5 w-2.5 border-b border-r border-primary/50" />
              <p className="text-[9px] md:text-[10px] text-muted-foreground italic" dangerouslySetInnerHTML={{ __html: `&ldquo;${ph.designProcess.quote}&rdquo;` }} />
            </div>
          </div>
        </div>
          ...
          <div className="relative flex items-center justify-center p-6 md:p-10 lg:p-12">
            <div className="space-y-4 md:space-y-5 w-full max-w-lg 3xl:max-w-xl 4xl:max-w-2xl">
              ...
              <div className="space-y-3 text-xs md:text-sm leading-relaxed text-foreground/70">
                <p dangerouslySetInnerHTML={{ __html: ph.inanilux.desc1 }} />
                <p dangerouslySetInnerHTML={{ __html: ph.inanilux.desc2 }} />
              </div>
              ...
              <div className="relative py-3 px-4">
                ...
                <div className="absolute bottom-0 left-0 h-2.5 w-2.5 border-b border-l border-primary/50" />
                <div className="absolute bottom-0 right-0 h-2.5 w-2.5 border-b border-r border-primary/50" />
                <p className="text-xs md:text-sm text-muted-foreground italic" dangerouslySetInnerHTML={{ __html: `&ldquo;${ph.inanilux.quote}&rdquo;` }} />
              </div>
            </div>
          </div>
        </div>
