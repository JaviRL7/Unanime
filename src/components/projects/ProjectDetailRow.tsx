          ...
          <div className="overflow-hidden p-4 md:p-6 lg:p-10 xl:p-12 lg:h-full">
            ...
            {isGalleryLayout || isStructuredLayout ? (
              ...
              <div className="space-y-1.5 md:space-y-2 lg:space-y-2.5 w-full">
                ...
                <div className="space-y-0.5">
                  <div className="flex items-center gap-0.5">
                    ...
                    <h4 className="font-mono text-[8px] font-semibold uppercase tracking-wider md:text-[9px] lg:text-[10px]">
                      {systemTitle}
                    </h4>
                  </div>
                  <p className="text-foreground/70 text-[8px] leading-relaxed pl-2 md:text-[9px] lg:text-[10px]" dangerouslySetInnerHTML={{ __html: systemDescription }} />
                </div>
                ...
                <div className="space-y-0.5">
                  ...
                  <ul className="text-foreground/70 text-[8px] leading-relaxed pl-2 space-y-1 md:text-[9px] lg:text-[10px]">
                ...
                <div className="pt-2 lg:pt-3 border-t mt-2">
                  <p className="text-muted-foreground text-[8px] font-mono italic md:text-[9px] lg:text-[10px] pr-6 md:pr-10 lg:pr-12 break-words hyphens-auto leading-relaxed" dangerouslySetInnerHTML={{ __html: `&ldquo;${quote}&rdquo;` }} />
                </div>
              ...
              <div className="space-y-1.5 md:space-y-2 lg:space-y-2.5">
                {/* Header */}
                <div className="border-l border-primary pl-1.5">
                  <h3 className="font-incognito text-[10px] md:text-xs lg:text-sm font-bold">
                    {title}
                  </h3>
                </div>
                ...
                {/* Footer con línea */}
                <div className="pt-2 lg:pt-3 border-t mt-2">
                  <p className="text-muted-foreground text-[8px] font-mono italic md:text-[9px] lg:text-[10px] pr-8 md:pr-12 lg:pr-16 break-words hyphens-auto leading-relaxed" dangerouslySetInnerHTML={{ __html: `&ldquo;${quote}&rdquo;` }} />
                </div>
              ...
              <div className="space-y-1.5 md:space-y-2 lg:space-y-2.5 w-full">
                ...
                {/* Description */}
                <p className="text-muted-foreground text-[8px] md:text-[9px] lg:text-[10px] leading-relaxed">
                  {description}
                </p>
