                        ...
                        {item.id === 3 && (
                          <div className="absolute inset-0 z-30 pointer-events-none opacity-0 group-hover/image:opacity-100 transition-opacity duration-300">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 md:gap-4 pointer-events-auto">
                              ...
                              <a href="#inanilux" className="group/btn relative inline-flex items-center gap-2 rounded-md border-2 bg-primary px-4 py-2 md:px-6 md:py-3 text-sm md:text-base font-medium text-primary-foreground transition-all duration-300 hover:bg-primary/90 mt-2 md:mt-4">
