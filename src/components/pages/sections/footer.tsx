    ...
    <footer className="border-t px-4 py-3.5 md:px-8">
      <div className="text-foreground/70 flex flex-col items-center justify-between gap-3 text-sm md:flex-row">
        ...
        <div className="inline-flex items-center gap-2">
          <Logo className="w-10" />
          <span>© {new Date().getFullYear()} Javier Rodríguez. Todos los derechos reservados.</span>
        </div>
        ...
        >
          <span className="text-foreground/60 text-sm">Hecho con</span>
          <Heart className={`h-4 w-4 fill-red-400 text-red-400`} />
          <span className="text-foreground/60 text-sm">en Next.js</span>
        </motion.div>
