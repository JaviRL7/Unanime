...
export const projects: Project[] = [
  ...
  // Proyecto 2 - Más funcionalidades
  {
    id: "more-features",
    hero: {
      title: "",
  ...
  // Proyecto 3 - Local Noise
  {
    ...
    hero: {
      ...
      mediaType: "video",
      mediaSrc: "/video/u7.mp4",
      badges: [],
      githubUrl: "https://github.com/JaviRL7/LocalNoise",
      demoUrl: "https://local-noise.vercel.app/",
    },
    details: [
      // Primera fila - Diseño inspirado en Spotify
      {
        date: "En desarrollo, 2025",
        status: "in-progress",
      ...
      // Segunda fila - Funcionalidades musicales
      {
        date: "En desarrollo, 2025",
        status: "in-progress",
  ...
  // Proyecto 4.1 - Arquitectura de Base de Datos
  {
    id: "tfg-arquitectura",
    hero: {
  ...
  // Proyecto 4.2 - Diagrama ERD
  {
    ...
    hero: {
      ...
      description: "",
      mediaType: "image",
      mediaSrc: "/diagrama/erd-diagram-1.png",
      badges: [],
      githubUrl: "https://github.com/JaviRL7/Arena",
      demoUrl: "/diagrama/erd-diagram-1.svg",
    },
    details: [],
  },
